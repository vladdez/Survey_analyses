...
italised2 <- rev(c('Bachelor', 'Master', 'PhD', 'Postdoc', 'Professor', 'Industry R&D', 'Medical doctor', expression(italic('Other'))))
position <- pos %>% 
...
ggarrange(country_fig + theme(axis.text.y = element_text(size = 10), axis.title.x = element_blank(), axis.text.x = element_blank()) + xlim(0, 30), 
          ...
          methods  + scale_y_discrete(labels=c("OPMs", "iEEG", "MEG", "Scalp EEG")) + xlim(0, 80) +  
...
```{r}
ggarrange(country_fig + geom_col(stat = "identity", width = 0.8, fill ="lightblue1", colour ="dodgerblue3",) + 
            theme(axis.title.x = element_blank(), axis.text.y = element_text(size = 10), axis.text.x = element_blank()) + xlim(0, 30), 
          position + xlim(0, 80) + geom_col(stat = "identity", fill ="lightblue1", colour ="dodgerblue3",) + 
            theme(axis.title.x = element_blank(), axis.text.y = element_text(size = 10), axis.text.x = element_blank()),  
          fieldplot + xlim(0, 100) + geom_col(stat = "identity", width = 0.7, fill ="lightblue1", colour ="dodgerblue3",) + 
            theme(axis.title.x = element_blank(), axis.text.y = element_text(size = 10), axis.text.x = element_blank()), 
          methods  + geom_col(stat = "identity", width = 0.7, fill ="lightblue1", colour ="dodgerblue3",) +  
            scale_y_discrete(labels=c("OPMs", "iEEG", "MEG", "Scalp EEG")) + xlim(0, 80) +  
            theme(axis.title.x = element_blank(), axis.text.y = element_text(size = 10), axis.text.x = element_blank()), 
          labels = c("A", "B", "C", "D"),
          ncol = 2, nrow = 2, align = 'hv')  
```
...
ggarrange(country_fig + geom_col(stat = "identity", width = 0.8, fill ="#6BAED6") + 
            theme(axis.title.x = element_blank(), axis.text.y = element_text(size = 10), axis.text.x = element_blank()) + xlim(0, 30), 
          position + xlim(0, 80) + geom_col(stat = "identity", fill ="#6BAED6") + 
            theme(axis.title.x = element_blank(), axis.text.y = element_text(size = 10), axis.text.x = element_blank()),  
...
ggarrange(years +  geom_col(position = "identity", bins = 45, fill ="#6BAED6") + 
  ...
  geom_vline(xintercept = tmp_med - 1,        # Add line for mean
          ...
          cc +  geom_col(stat = "identity",  width = 0.5, fill ="#6BAED6") + xlim(0, 73) + theme(axis.title.x = element_blank(), axis.text.y = element_text(size = 10), axis.text.x = element_blank()), 
  
          sall + geom_col(stat = "identity",  width = 0.5, fill ="#6BAED6") + xlim(0, 53) + theme(axis.title.x = element_blank(), axis.text.y = element_text(size = 10), axis.text.x = element_blank()), 
          labels = c("A", "B", "C", "D"),
          ncol = 2, nrow = 2, align = 'h') 
