...
cit_data <- rbind(cit1, cit5, cit3, cit4, cit2) %>% rename_at(vars(colnames(.)), ~ c("year", "citations", "name"))
```
...
chart <- d %>% 
    ...
    labs(x="Percent of respondents",title="Which EEG, MEG, or iEEG analysis platform\nhave you used for ERP plotting?") +
