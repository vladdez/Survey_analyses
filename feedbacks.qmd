...
# for (i in 1:8){
#   image_write(mins[i], path = paste0("miniatures/", i, ".png"), format = "png", density = 1000)
# }
...
```{r}
write.xlsx(n1 %>% 
   rename_at(vars(colnames(.)), ~ c("Plot names", "Scores")), "data/aggregated_plotnames.xlsx", sheetName ="ERP plot", row.names=FALSE)
write.xlsx(n2 %>% 
