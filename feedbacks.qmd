...
```{r}
cm <- dplyr::tibble(
  image = c("img/1.png", "img/2.png", "img/3.png", "img/4.png", "img/5.png", "img/6.png", "img/7.png", "img/8.png"),
  plots = c("ERP plot", "Butterfly plot", "Topoplot", "Topoplot timeseries", "ERP grid", "ERP image", "Channel image", "Parallel plot"), 
  time = c("x", "x", "", "(x)", "x", "x", "x", "x"),
  channels = c("", "x", "x", "x", "x", "", "x", "x"), 
  spatial = c("", "", "x", "x", "x", "", "", ""), 
  conditions = c("x", "", "", "", "", "", "", "x"), 
