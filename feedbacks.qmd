...
```{r}
plots3 <- c("img/1.png", "img/filler.png", "img/filler.png", "img/5.png", "img/filler.png", "img/filler.png", "img/4.png","img/filler.png", "img/filler.png", "img/7.png", "img/filler.png", "img/filler.png", "img/2.png", "img/filler.png", "img/filler.png", "img/3.png", "img/filler.png", "img/filler.png", "img/6.png", "img/filler.png", "img/filler.png")
...
probs_pic <- probs %>% flextable() %>% 
  ...
  hline_bottom(part = "body", border = fp_border(color = "white", width = 3)) %>% 
  font(fontname = "Lato", part="all") #%>% save_as_image("probs.png")
probs_pic
```
...
```{r}
eeglab <- fordev2 %>% filter(grepl("eeglab", soft)) %>% write.csv("feedback/eeglab.csv")
fieldtrip <- fordev2 %>% filter(grepl("fieldtrip", soft))  %>% write.csv("feedback/fieldtrip.csv")
mne <- fordev2 %>% filter(grepl("mne", soft)) %>% write.csv("feedback/mne.csv")
erplab <- fordev2 %>% filter(grepl("erplab", soft)) %>% write.csv("feedback/erplab.csv")
BVA <- fordev2 %>% filter(grepl("brain vision analyser", soft)) %>% write.csv("feedback/BVA.csv")
brainstorm <- fordev2 %>% filter(grepl("brainstorm", soft)) %>% write.csv("feedback/brainstorm.csv")

#spm <- fordev2 %>% filter(grepl("spm", soft))
#besa <- fordev2 %>% filter(grepl("besa", soft))
#cartool <- fordev2 %>% filter(grepl("cartool", soft))
#unfold <- fordev2 %>% filter(grepl("unfold", soft))
