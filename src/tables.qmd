...
n1 <- read_xlsx("../data/aggregated_plotnames.xlsx")
...
problem1 <- readxl::read_xlsx("../data/aggregated_problems.xlsx")
...
tab_options(#container.width = 1500, container.height = 1500, 
            data_row.padding = px(0.1), table.font.size = 14, container.padding.x = 1,  column_labels.border.bottom.color = "black",column_labels.border.top.color = "white",
