...
f4 <- ggarrange(country_fig + geom_col(stat = "identity", width = 0.8, fill ="#6BAED6") + 
            theme(axis.text.y = element_text(size = 12), plot.title = element_text(size = 14), axis.text.x = element_blank()) + xlim(0, 100) + labs(x= "Percent of respondents"), 
          position + xlim(0, 100) + geom_col(stat = "identity", fill ="#6BAED6") + 
            theme(axis.text.y = element_text(size = 12), plot.title = element_text(size = 14), axis.text.x = element_blank()) + labs(x = "Percent of respondents"),   
...
ggsave("Figure 4.jpg", f4, units = "px", dpi=100, width = 1500, height = 938)
```
...
years <- year %>% group_by(years) %>% 
  ...
  labs(title ="Years of experience", y= "Percent of\nrespondents", x="")  +
...
f5 <- ggarrange(years +  geom_col(position = "identity", bins = 45, fill ="#6BAED6") + 
  ...
  geom_vline(xintercept = tmp_med - 1,        # Add line for mean
    ...
    labs(x ="Percent of respondents"), 
          ...
          ncol = 2, nrow = 2) 
f5
ggsave("Figure 5.jpg", f5, units = "px", dpi=150, width = 1500, height = 931)
```
...
ggsave("Figure 6.jpg", f6, units = "px", dpi=200, width = 1500, height = 916)
```
...
ggsave("Figure 7.jpg", f7, units = "px", dpi=200, width = 1500, height = 916)
```
...
ggsave("Figure 8.jpg", f8, units = "px", dpi=200, width = 1700, height = 916, bg = "white")
```
...
ggsave("Figure 9.jpg", f9, units = "px", dpi=200, width = 1700, height = 916, bg = "white")
```
...
ggsave("Figure 10.jpg", f10, units = "px", dpi=200, width = 1700, height = 916, bg = "white")
```
...
ggsave("Figure 11.jpg", f11, units = "px", dpi=250, width = 1700, height = 465, bg = "white")
```
